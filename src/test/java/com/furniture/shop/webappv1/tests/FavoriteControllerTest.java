...
public class FavoriteControllerTest {
	...
	@Ignore
	@Test
	public void getFavoriteByIdTest() throws Exception{
		this.mockMvc.perform(get("/favorites/30")).andDo(print())
		.andExpect(status().isOk());
	...
	public void createFavoriteTest() throws Exception{
		...
		// can't update child raw	
		
		
        ObjectMapper mapper = new ObjectMapper();
        mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
        ObjectWriter ow = mapper.writer().withDefaultPrettyPrinter();
        String requestJson=ow.writeValueAsString(favorite);
        mockMvc.perform(post("/favorites").contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(status().isOk());
	...
	public void updateFavoriteTest() throws Exception{
        ...
        ObjectWriter ow = mapper.writer().withDefaultPrettyPrinter();
        String requestJson=ow.writeValueAsString(favorite);
        mockMvc.perform(put("/favorites").contentType(APPLICATION_JSON_UTF8)
                .content(requestJson))
                .andExpect(status().isOk());
	...
	public void deleteProductTagByIdTest() throws Exception{
		this.mockMvc.perform(delete("/favorites/30")).andDo(print())
		.andExpect(status().isOk());
